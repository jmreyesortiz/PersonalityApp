...
public class ResultActivity extends AppCompatActivity {
    ...
    HorizontalBarChart mHorizontalBarChart2;
    HorizontalBarChart mHorizontalBarChart3;
    HorizontalBarChart mHorizontalBarChart4;
    HorizontalBarChart mHorizontalBarChart5;

    TextView mAgreeablenessTextview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHorizontalBarChart = findViewById(R.id.HORIZONTAL_BAR_CHART_1);
       ...
       mAgreeablenessTextview = findViewById(R.id.Agreeableness_Description);



        setRadarChart(mRadarChart);
        setHorizontalChart(mHorizontalBarChart, 0);
    ...
    public void setHorizontalChart(HorizontalBarChart mHorizontalBarChart, int trait){
        ...
        barDataSet.setColor(Color.BLUE);   //Color of Bar
        ...
        mHorizontalBarChart.animateXY(4000,4000, Easing.EaseOutSine);
    ...
    public void setRadarChart(RadarChart mRadarChart){
        ...
        radarDataSet.setColor(Color.BLUE);// Color of LINES
